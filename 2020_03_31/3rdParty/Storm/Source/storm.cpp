...
BOOL STORMAPI SNetCreateGame(const char *pszGameName, const char *pszGamePassword, const char *pszGameStatString, DWORD dwGameType, void *GameTemplateData, int GameTemplateSize, int playerCount, char *creatorName, char *a11, DWORD *playerID) rBool;
...
BOOL STORMAPI SNetGetGameInfo(int type, void *dst, size_t length, DWORD *byteswritten) rBool;
...
BOOL STORMAPI SNetReceiveMessage(DWORD *senderplayerid, char **data, DWORD *databytes) rBool;
BOOL STORMAPI SNetReceiveTurns(int a1, int arraysize, void *arraydata, void *arraydatabytes, void *arrayplayerstatus) rBool;
...
BOOL STORMAPI SNetSetGameMode(DWORD modeFlags, _bool makePublic) rBool;
...
BOOL STORMAPI SFileDdaGetPos(HANDLE directsound, DWORD *a2, DWORD *a3) rBool;
...
BOOL STORMAPI SRegLoadValue(const char *keyname, const char *valuename, BYTE flags, DWORD *value) rBool;
...
BOOL STORMAPI SVidPlayBegin(const char *filename, int arg4, int a3, int a4, int a5, int a6, HANDLE* video) rBool;
...
BOOL __cdecl SErrDisplayErrorFmt(DWORD dwErrMsg, const char *logfilename, int logline, BOOL allowOption, int exitCode, const char *format, ...) rBool;
...
_bool __cdecl StormDestroy(void) rBool;
_bool __stdcall SFileSetBasePath(char *) rBool;
void __cdecl SDrawRealizePalette(void) rVoid;
BOOL __stdcall SVidPlayContinue(void) rBool;
BOOL __stdcall SNetGetOwnerTurnsWaiting(DWORD *) rBool;
BOOL __stdcall SNetUnregisterEventHandler(int,void (__stdcall*)(struct _SNETEVENT *)) rBool;
BOOL __stdcall SNetRegisterEventHandler(int,void (__stdcall*)(struct _SNETEVENT *)) rBool;
_bool __stdcall SNetSetBasePlayer(int) rBool;
